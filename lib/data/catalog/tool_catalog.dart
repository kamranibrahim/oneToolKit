...
abstract final class ToolCatalog {
  static final List<ToolModel> all = [
    ...
    const ToolModel(
      ...
      route: AppRoutes.htmlFormatter,
      keywords: ['markup', 'beautify', 'minify'],
    ),
    const ToolModel(
      id: 'xml_formatter',
      name: 'XML Formatter',
      description: 'Beautify or minify XML',
      category: ToolCategory.documents,
      icon: Icons.account_tree_outlined,
      route: AppRoutes.xmlFormatter,
      keywords: ['markup', 'beautify', 'minify'],
    ),
    const ToolModel(
      id: 'css_formatter',
      ...
      route: AppRoutes.cssFormatter,
      keywords: ['stylesheet', 'beautify', 'minify'],
    ),
    const ToolModel(
      id: 'sql_formatter',
      name: 'SQL Formatter',
      description: 'Beautify or minify SQL',
      category: ToolCategory.documents,
    ...
    const ToolModel(
      id: 'notepad',
      name: 'Notepad',
      description: 'Private notes stored on device',
      category: ToolCategory.documents,
    ...
    const ToolModel(
      id: 'line_tools',
      name: 'Line Tools',
      description: 'Sort, unique, reverse, number lines',
      category: ToolCategory.text,
    ...
    const ToolModel(
      ...
      description: 'Text ↔ decimal or hex codes',
      category: ToolCategory.text,
      icon: Icons.abc_rounded,
      route: AppRoutes.asciiConverter,
      keywords: ['unicode', 'codepoint', 'hex', 'char'],
    ),
    const ToolModel(
      id: 'morse_code',
      name: 'Morse Code',
      ...
      route: AppRoutes.morseCode,
      keywords: ['dot', 'dash', 'telegraph'],
    ),
    const ToolModel(
      id: 'roman_numeral',
      name: 'Roman Numerals',
      description: 'Convert numbers and Roman numerals',
      category: ToolCategory.text,
      icon: Icons.filter_9_plus_rounded,
      route: AppRoutes.romanNumeral,
      keywords: ['roman', 'latin', 'numeral'],
    ),
    const ToolModel(
      id: 'html_entities',
      name: 'HTML Entities',
    ...
    const ToolModel(
      id: 'binary_text',
      name: 'Binary Text',
      description: 'Text ↔ binary bytes',
      category: ToolCategory.text,
      icon: Icons.memory_rounded,
      route: AppRoutes.binaryText,
      keywords: ['bits', '01', 'encode'],
    ),
    const ToolModel(
      id: 'regex_tester',
      name: 'Regex Tester',
    ...
    const ToolModel(
      ...
      description: 'Integers, dice, picks, and strings',
      category: ToolCategory.developer,
    ...
    const ToolModel(
      ...
      keywords: ['cidr', 'subnet', 'netmask', 'network'],
    ),
    const ToolModel(
      id: 'cron_explainer',
      name: 'Cron Explainer',
      description: 'Explain 5-field cron schedules',
      category: ToolCategory.developer,
    ...
    const ToolModel(
      ...
      description: 'Sale price, savings, and optional tax',
      category: ToolCategory.developer,
    ...
    const ToolModel(
      id: 'query_string',
      name: 'Query String',
      description: 'Parse and build URL query params',
      category: ToolCategory.developer,
      icon: Icons.link_rounded,
    ...
    const ToolModel(
      id: 'fuel_cost',
      name: 'Fuel Cost',
      description: 'Trip fuel use and cost',
      category: ToolCategory.developer,
      icon: Icons.local_gas_station_rounded,
      route: AppRoutes.fuelCost,
      keywords: ['gas', 'petrol', 'mpg', 'trip'],
    ),
    const ToolModel(
      id: 'password_strength',
      name: 'Password Strength',
      description: 'Check password strength offline',
      category: ToolCategory.developer,
    ...
    const ToolModel(
      id: 'days_until',
      name: 'Days Until',
      description: 'Countdown between two dates',
      category: ToolCategory.developer,
    ...
    const ToolModel(
      id: 'rem_px',
      name: 'rem ↔ px',
      description: 'Convert CSS rem and pixels',
      category: ToolCategory.developer,
      icon: Icons.straighten_rounded,
      route: AppRoutes.remPx,
      keywords: ['css', 'font', 'root', 'em'],
    ),
